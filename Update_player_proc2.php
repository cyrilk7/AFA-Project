...
<html>
    ...
    if (isset($_GET['update'])){
        ...
        if($conn -> connect_error){
            ...
            if($originalTeamID === '2'){
                header("Location: elite-admin.php?teamid=2");
                exit();
            }
            if($originalTeamID === '3'){
                header("Location: kasanoma-admin.php?teamid=3");
                exit();
            }
            if($originalTeamID === '4'){
                header("Location: highlanders-admin.php?teamid=4");
                exit();
            }
            if($originalTeamID === '5'){
                header("Location: legends-admin.php?teamid=5");
                exit();
            }
            if($originalTeamID === '6'){
                header("Location: northside-admin.php?teamid=6");
                exit();
            }
            if($originalTeamID === '7'){
                header("Location: highlanders-admin.php?teamid=7");
                exit();
            }
