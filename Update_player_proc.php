    ...
    <form
              ...
              >
                ...
                <select
                  ...
                  required
                >
                <option name = "Kasanoma" value = "1"> Kasanoma</option>
                <option name = "Elite" value = "2"> Elite</option>
                <option name = "Northside" value = "3"> Northside</option>
                <option name = "Legends" value = "4"> Legends</option>
                <option name = "Highlanders" value = "5"> Highlanders</option>
                <option name = "Red Army" value = "6"> Red Army</option>
